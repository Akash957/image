...
class NotesDatabaseHelper(context: Context) : SQLiteOpenHelper(
    ...
    fun updateNote(note:Note){
        ...
        val whereArag= arrayOf(note.id.toString())
        db.update(TABLE_NAME,values,whereClaus,whereArag)
        db.close()
    }
    ...
    fun deleteNote(noteId: Int){
        ...
        val whereArag= arrayOf(noteId.toString())
        db.delete(TABLE_NAME,whereClause,whereArag)
        db.close()
    }
}